          ...
          <div className="flex flex-col flex-grow">
            <div className="bg-primary-light dark:bg-primary-dark pr-6 w-full">
              <div className="flex flex-col">
                <div className="h-24 ml-6 flex items-center gap-4 ">
                  <div
                    onClick={() => handleProfileClick(otherUser)}
                    className="flex gap-4 items-center hover:opacity-80 transition-opacity cursor-pointer"
                  >
                  ...
                  {/* <div
                    ...
                    className="ml-auto flex gap-2 h-6"
                  >
                    <svg
                      onClick={() => {}}
